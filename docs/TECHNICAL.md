...
Go 版本需要与 `go.mod` 保持一致。当前项目使用 `modernc.org/sqlite` 作为无 CGO SQLite 驱动，最低源码编译版本为 Go 1.25；Dockerfile 和 GitHub Actions 都应使用 Go 1.25 或更高版本。
